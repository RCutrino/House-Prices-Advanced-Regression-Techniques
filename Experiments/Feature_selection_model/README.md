...
## Objective
Test whether applying SelectFromModel with best model selected improves generalization performance compared to the baseline model.

---

## Methodology
- Same preprocessing pipeline as baseline
- Feature selection using best model selected-based SelectFromModel
